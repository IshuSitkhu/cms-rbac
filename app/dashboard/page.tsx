...
//       setUser({
//         _id: decoded.userId,
//         username: "User", // optionally fetch real username from backend
//         email: "",
...
//             <CategoryTable canEdit={true} canDelete={true} />
//           </div>

//           <div>
//             <h3 className="text-lg font-semibold mb-2">Users</h3>
//             <UsersTable canEdit={true} canDelete={true} />
//           </div>

//           <div>
//             <h3 className="text-lg font-semibold mb-2">Roles</h3>
//             <RolesTable canEdit={true} canDelete={true} />
//           </div>
//         </div>
//       )}
